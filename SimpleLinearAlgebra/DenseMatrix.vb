Imports SimpleLinearAlgebra.Utility
...
#Region "Public Func"
        ...
        Public Function Inverse(Optional ByVal same_zero_value As Double = SAME_ZERO) As DenseMatrix
            ...
            If n = 0 Then
                'nop
            ElseIf n = 1 Then
                If SimpleLinearAlgebra.Utility.MathUtil.IsCloseToZero(source(0)(0)) = True Then
        ...
        Public Function Cholesky() As DenseMatrix
            ...
            Dim ret As New SimpleLinearAlgebra.Math.DenseMatrix(Me.RowCount)
